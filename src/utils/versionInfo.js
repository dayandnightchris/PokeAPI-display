...
// Map a version group (PokéAPI name) to its individual version names.
// Some groups (DLC, Legends) reuse their base game's versions.
export const versionGroupToVersions = {
  'red-blue': ['red', 'blue'],
  'yellow': ['yellow'],
